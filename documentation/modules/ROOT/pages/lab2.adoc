...
* You might see this error `Unable to verify existence of operator id [camel-k] due to lack of user privileges`. This is a known camel-k issue(https://github.com/apache/camel-k/issues/3996) which can safely be ignored
